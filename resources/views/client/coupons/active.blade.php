                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <ul class="list-unstyled small mb-3">
                                        @if ($coupon->start_date)
                                            <li>Bắt đầu: {{ \Carbon\Carbon::parse($coupon->start_date)->format('d/m/Y') }}
                                            </li>
                                        @endif
                                        @if ($coupon->end_date)
                                            <li>Kết thúc: {{ \Carbon\Carbon::parse($coupon->end_date)->format('d/m/Y') }}
                                            </li>
                                        @endif
                                    </ul>
                                    ...
                                    @if ($coupon->restriction)
                                        <small class="text-muted">Đơn tối thiểu:
                                            {{ number_format($coupon->restriction->min_order_value) }} VND</small><br>
