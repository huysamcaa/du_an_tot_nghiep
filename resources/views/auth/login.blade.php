...
@section('content')
    <form action="{{ route('login') }}" method="POST" class="signin-form">
        ...
        <div class="form-group">
            <div class="position-relative">
                <input id="password-field" type="password" name="password" class="form-control pr-5" placeholder="Mật khẩu">
    ...
    <p class="w-100 text-center">Bạn chưa có tài khoản? <a href="{{ route('register') }}" style="color: #ffc107">Đăng ký</a>
    </p>
@endsection
