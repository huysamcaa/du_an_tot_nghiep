...
@section('content')
    ...
    <form action="{{ route('password.change') }}" method="POST" class="signin-form">
        ...
        <div class="form-group">
            <div class="position-relative">
                <input type="password" name="current_password"
                    class="form-control @error('current_password') is-invalid @enderror" placeholder="Mật khẩu hiện tại">
            </div>
        ...
        <div class="form-group">
            <div class="position-relative">
                <input type="password" name="new_password" class="form-control @error('new_password') is-invalid @enderror" placeholder="Mật khẩu mới"> <span toggle="#password-field"
