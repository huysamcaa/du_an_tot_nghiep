                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4"><strong>Trạng thái đơn hàng:</strong>
                            <span
                                class="badge bg-success">{{ $order->currentStatus?->orderStatus?->name ?? 'Chờ thanh toán' }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST" class="form-inline">
                        ...
                        <div class="input-group" style="max-width: 320px;">
                            ...
                            <button type="submit" class="btn btn-primary ms-2" {{ $isFinal ? 'disabled' : '' }}>Cập
                                nhật</button>
                        </div>
                            ...
                            <tbody>
                                @foreach ($order->items as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->quantity }}</td>
                                        <td>{{ number_format(($item->variant ? $item->variant->price : $product->price) * $item->quantity, 0, ',', '.') }}
                                            đ</td>
                                    </tr>
                                @endforeach
                            </tbody>
