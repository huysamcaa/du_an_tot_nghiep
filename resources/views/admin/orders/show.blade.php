                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="info-section">
                                    <h6 class="info-title"><i class="fas fa-credit-card me-2"></i>Thanh toán & Vận chuyển
                                    </h6>
                                    <div class="info-content">
                                        <div class="mb-2">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div
                                    class="alert alert-{{ getStatusColor($order->currentStatus?->orderStatus?->slug ?? 'pending', true) }} mb-3">
                                    <i
                                        class="fas {{ getStatusIcon($order->currentStatus?->orderStatus?->slug ?? 'pending') }} me-2"></i>
                        ...
                        <div class="order-timeline">
                            ...
                            @foreach ($histories as $index => $history)
                                <div class="timeline-item {{ $index === count($histories) - 1 ? 'current' : '' }}">
                                    <div
                                        class="timeline-icon bg-{{ getStatusColor($history->orderStatus->slug ?? 'pending') }}">
