...
<table class="table table-bordered table-hover">
    ...
    <a href="{{ route('admin.orders.show', $order->id) }}" class="btn btn-sm btn-info" title="Xem đơn hàng">
        <i class="fa fa-eye"></i>
    </a>
    <form action="{{ route('admin.orders.destroy', $order->id) }}" method="POST" style="display:inline;">
        @csrf @method('DELETE')
        <button onclick="return confirm('Xóa đơn hàng?')" class="btn btn-sm btn-danger" title="Xóa đơn hàng">
