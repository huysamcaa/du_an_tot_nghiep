        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" name="icon" id="icon" class="form-control" placeholder="<i class='fa fa-icon'></i>" value="{{ old('icon', $category->icon) }}">
            </div>
            <div class="col-md-6">
              <label for="ordinal" class="font-weight-bold">Thứ tự hiển thị <span class="text-danger">*</span></label>
              <input type="number" name="ordinal" id="ordinal" class="form-control" value="{{ old('ordinal', $category->ordinal) }}" required>
            </div>
          </div>
