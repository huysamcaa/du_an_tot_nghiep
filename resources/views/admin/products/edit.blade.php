                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline me-4">
                                    <input class="form-check-input" type="checkbox" name="is_sale" value="1" {{ old('is_sale', $product->is_sale) ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $product->thumbnail) }}" alt="Thumbnail" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                                @endif
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge bg-info text-white mb-1">{{ $attrValue->attribute->name }}: {{ $attrValue->value }}</span>
