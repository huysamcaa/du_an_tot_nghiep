        ...
        <div class="card-body p-0">
          <table class="table table-striped table-bordered text-center align-middle mb-0">
                ...
                <th colspan="6" class="p-3">
                  <div class="d-flex justify-content-between align-items-center flex-wrap" style="gap:12px;">
                    <div class="d-flex align-items-center" style="gap:8px;">
                      <button type="submit" id="btn-bulk-restore" class="btn btn-outline-success btn-sm" disabled>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <form action="{{ route('admin.coupon.restore', $coupon->id) }}"
                          ...
                          onsubmit="return confirm('Khôi phục mã này?')">
                      @csrf
              ...
              @empty
                <tr>
                  <td colspan="6" class="text-center text-muted">Không có mã giảm giá nào đã bị xóa.</td>
                </tr>
              @endforelse
            </tbody>
          </table>
