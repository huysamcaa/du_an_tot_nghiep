...
@endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_group" class="form-control">
                                    ...
                                    <option value="guest" {{ old('user_group', $coupon->user_group) == 'guest' ? 'selected' : '' }}>Khách
                                    </option>
                                    <option value="member" {{ old('user_group', $coupon->user_group) == 'member' ? 'selected' : '' }}>
                                        Thành Viên</option>
                                    <option value="vip" {{ old('user_group', $coupon->user_group) == 'vip' ? 'selected' : '' }}>VIP
                                    </option>
                                </select>
                            </div>
                        </div>
