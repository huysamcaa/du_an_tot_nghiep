...
@section('content')
    ...
    <a href="{{ route('admin.coupon.create') }}" class="btn btn-primary mb-3">Thêm mã giảm giá</a>
    <a href="{{ route('admin.coupon.trashed') }}" class="btn btn-secondary mb-3">Mã đã xóa</a>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.coupon.destroy', $coupon->id) }}"
                                                    ...
                                                    <button class="btn btn-sm btn-danger"
                                                        onclick="return confirm('Xác nhận xóa mã này?')">Xóa</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
