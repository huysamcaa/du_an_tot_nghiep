...
<div class="content">
  <div class="animated fadeIn">
    ...
    <form action="{{ route('admin.coupon.store') }}" method="POST" novalidate>
      ...
      {{-- Tabs --}}
      <ul class="nav nav-tabs nav-tabs-solid mb-3" id="couponCreateTabs" role="tablist">
      ...
      <div class="tab-content" id="couponCreateTabsContent">
        {{-- TAB 1: Thông tin --}}
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Khởi tạo select2 nếu có (an toàn khi lib đã được load sẵn)
    if (window.jQuery && typeof jQuery.fn.select2 === 'function') {
      jQuery('.select2').select2({ placeholder:'Chọn...', allowClear:true });
    }
  });
</script>
@endpush
